...
<body class="bg-gray-50">
    <div x-data="{
        sidebarOpen: false,
        cartOpen: false,
        {{-- currentStore: {{ json_encode($stores->first()) }},
        ...
        <div class="flex flex-1">
            ...
            <div x-cloak :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
                ...
                <div class="flex flex-col h-full overflow-y-auto ">
                    <div class="p-4 border-b">
                        <h2 class="text-xl font-bold text-center">Pilih Kantin</h2>
                    </div>
                    ...
                    <div class="p-4">
                        <p class="text-sm text-gray-500">&copy; 2025 QRasa. All rights reserved</p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex-1 flex flex-col md:ml-0">
                ...
                <div class="p-4">
                    ...
                    <div class="relative h-40 w-full overflow-hidden rounded-lg mb-6">
                        <img :src="currentStore.image" :alt="currentStore.name" class="w-full h-full object-contain">
                    </div>
                        ...
                        <template x-for="item in menuItems" :key="item.id">
                            <div class="bg-white rounded-lg overflow-hidden shadow-md">
                                <div class="relative h-48 w-full">
                                    ...
                                    <span x-show="item.discount > 0" x-text="item.discount + '% OFF'"
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="mt-2 flex items-center gap-2">
                                        <span class="font-bold"
                                            x-text="formatPrice(item.price - (item.price * item.discount / 100))"></span>
                                        <span x-show="item.discount > 0" x-text="formatPrice(item.price)"
            ...
            <div x-cloak x-show="cartOpen" class="fixed inset-0 z-50 overflow-hidden"
                ...
                <div class="fixed inset-y-0 right-0 max-w-full flex">
                    <div x-show="cartOpen" class="w-screen max-w-md"
